...
<div class="page page-admin_login">
<h1>Admin Login</h1>
</br></br></br>
<div class="container">
<form action="page-admin_login.php" class="form-horizontal" role="form" method="POST">
...
if(isset($_POST['email']) && isset($_POST['pwd']))
{
  ...
  $pwd = md5($_POST['pwd']);
    ...
    $sql = "SELECT EMAIL_ID FROM ADMIN WHERE EMAIL_ID = '$email'";
    $result = $conn->query($sql);
    if($result->num_rows > 0)
      {  
        
        $sql = "SELECT * FROM ADMIN WHERE EMAIL_ID = '$email' AND PASSWORD = '$pwd'";
        $result = $conn->query($sql);
        /*if($result->fetch_assoc() === $pwd)
          ...
          foreach ($result as $row) {
            ...
            header("location:http://localhost/dbms_prj/index.html#/admin_menu");
          }
          echo "<h2>Invalid Password/Email ID</h2>";
      }
    else
